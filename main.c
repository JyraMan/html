...
int main() {
    ...
    int isValidUnit = 0;
	    ...
	    //определяем, какую единицу измерения ввели с клавиатуры (В ДАННОМ СЛУЧАЕ СЕКУНДЫ)
            ...
            printf("+---------------------------+\n");
	    printf("| e) |           | SEC to MONTH(30d)  |\n");
            printf("+---------------------------+\n");
            printf("| f) |           | SEC to MONTH(31d)  |\n");
	    printf("+---------------------------+\n");
            printf("| g) |           | SEC to MONTH(28d)  |\n");
            printf("+---------------------------+\n");
	    printf("| h) |           | SEC to YEAR  |\n");
            printf("+---------------------------+\n");
	    ...
	    //определяем, какую единицу измерения ввели с клавиатуры (В ДАННОМ СЛУЧАЕ МИНУТЫ)
            ...
            printf("+---------------------------+\n");
	    printf("| e) |           | MIN to MONTH(30d)  |\n");
            printf("+---------------------------+\n");
            printf("| f) |           | MIN to MONTH(31d)  |\n");
            printf("+---------------------------+\n");
            printf("| g) |           | MIN to MONTH(28d)  |\n");
            printf("+---------------------------+\n");
            printf("| h) |           | MIN to YEAR  |\n");
            printf("+---------------------------+\n");
	    ...
	    //определяем, какую единицу измерения ввели с клавиатуры (В ДАННОМ СЛУЧАЕ ЧАСЫ)
            ...
            printf("+---------------------------+\n");
	    printf("| e) |           | HOUR to MONTH(30d)  |\n");
            printf("+---------------------------+\n");
            printf("| f) |           | HOUR to MONTH(31d)  |\n");
            printf("+---------------------------+\n");
            printf("| g) |           | HOUR to MONTH(28d)  |\n");
            printf("+---------------------------+\n");
            printf("| h) |           | HOUR to YEAR  |\n");
            printf("+---------------------------+\n");
